...
import {Paper, IconMenu, MenuItem, IconButton, FontIcon, ListItem, ListDivider, Avatar} from 'material-ui';
...
constructor(props) {
  ...
  commentExpandClick(e) {
      ...
      this._listItem1._handleNestedListToggle(e);
    ...
    commentClick(e) {
     ...
     //  this._commentText.style.overflow = 'visible';
      // this._commentText.style.display = 'block';
       //this._commentText.style.marginBottom = '0px';
